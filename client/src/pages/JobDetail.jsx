    ...
    <div className='text-white container mx-auto'>
      <div className="w-full flex flex-col md:flex-row gap-10">
        ...
        {isFetching ? (
          ...
          <div className='w-full h-fit md:w-2/3 2xl:2/4 bg-slate-800 px-5 py-10 md:px-10 shadow-md'>
            ...
            <div className='w-full flex flex-wrap md:flex-row gap-2 items-center justify-between my-10 text-blue-900'>
                ...
                selected === "0" ? (
                  <>
                    ...
                    {job?.detail[0]?.requirements && (
                      <>
                        <p className="text-xl font-semibold mt-9">
                          Requirement
                        </p>
                        <span className="text-base">
                          {job?.detail[0]?.requirements}
