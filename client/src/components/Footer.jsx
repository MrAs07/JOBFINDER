    ...
    <footer className="text-white mp-20">
      ...
      <div className='bg-[#1d4ed8]'>
          ...
          <div className='w-full flex flex-wrap gap-10 justify-between -mb-10 px-4'>
            {footerLinks.map(({ id, title, links }) => (
              <div className='w-auto px-4' key={id + title}>
                <h2 className='font-medium text-white tracking-wides text-sm mb-3'>
                  {title}
                </h2>
        ...
        <div className=''>
            ...
            <div lassName='container mx-auto px-5 pt-6 pb-8 flex flex-wrap items-center justify-between '>
